// Implement the class template (Dec through template) Provide the necessary methods for
// working with the data structure specified in the variant. Provide for exceptional situations that may arise during operation.
...
template <class Type>
Deck<Type>::Deck(unsigned size):max_size(size),size(0),list(DoubleLinkedList<Type>()){};
